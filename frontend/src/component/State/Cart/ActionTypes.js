...
export const UPDATE_CARTITEM_REQUEST = "UPDATE_CART_ITEM_REQUEST";
export const UPDATE_CARTITEM_SUCCESS = "UPDATE_CART_ITEM_SUCCESS";
export const UPDATE_CARTITEM_FAILURE = "UPDATE_CART_ITEM_FAILURE";

export const REMOVE_CARTITEM_REQUEST = "REMOVE_CART_ITEM_REQUEST";
export const REMOVE_CARTITEM_SUCCESS = "REMOVE_CART_ITEM_SUCCESS";
export const REMOVE_CARTITEM_FAILURE = "REMOVE_CART_ITEM_FAILURE";